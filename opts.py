...
def parse_opts():
    ...
    parser.add_argument('--snapshot_pref', type=str, default="custom")
    ...
    parser.add_argument('--testdata', type=str, help='test data path')
    parser.add_argument('--video_name', type=str, help='make video and save(*.avi)')
    parser.add_argument('--visuable', type=bool, help='visual result video')
